    ...
    try {
        ...
        while (op != 0) {
            ...
            case 1:
                ...
                bool opcao;
                cout << "\nDeseja cadastrar um novo patógeno?\n[1]Sim]\n[0]Não\n";
                cin >> opcao;

                if (opcao) cadastrarPatogeno(connection);

                cadastrarDoenca(connection);

                cadastrarNomePopular(connection);
